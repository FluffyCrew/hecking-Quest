...
public:
	...
	static const int FLOAT_FRAMES_COUNT = 2;
	static const int HIT_FRAMES_COUNT = 1;

	static const int FLOAT_FRAMES_SPEED = 15;

	SDL_Rect floatFrameclip[FLOAT_FRAMES_COUNT];
	SDL_Rect hitFrameclip[HIT_FRAMES_COUNT];

	void followPlayerX(Player player);
	void followPlayerY(Player player);
};